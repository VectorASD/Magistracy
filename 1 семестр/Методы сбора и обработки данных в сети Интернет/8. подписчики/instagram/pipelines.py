...
#   Запросы
# Задание не требовало пихать всё в одну таблицу (единую коллекцию связей) для работы с агрегатами, пересечениями и аналитикой...
# db[f"follower_{username}"].find({})
# db[f"following_{username}"].find({})
